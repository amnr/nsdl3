...
const
  ...
  SCANCODE_AUDIONEXT*           = Scancode 258
  SCANCODE_AUDIOPREV*           = Scancode 259
  SCANCODE_AUDIOSTOP*           = Scancode 260
  SCANCODE_AUDIOPLAY*           = Scancode 261
  SCANCODE_AUDIOMUTE*           = Scancode 262
  SCANCODE_MEDIASELECT*         = Scancode 263
  SCANCODE_WWW*                 = Scancode 264
  SCANCODE_MAIL*                = Scancode 265
  SCANCODE_CALCULATOR*          = Scancode 266
  SCANCODE_COMPUTER*            = Scancode 267
  SCANCODE_AC_SEARCH*           = Scancode 268
  SCANCODE_AC_HOME*             = Scancode 269
  SCANCODE_AC_BACK*             = Scancode 270
  SCANCODE_AC_FORWARD*          = Scancode 271
  SCANCODE_AC_STOP*             = Scancode 272
  SCANCODE_AC_REFRESH*          = Scancode 273
  SCANCODE_AC_BOOKMARKS*        = Scancode 274

  # Walther keys.
  SCANCODE_BRIGHTNESSDOWN*      = Scancode 275
  SCANCODE_BRIGHTNESSUP*        = Scancode 276
  SCANCODE_DISPLAYSWITCH*       = Scancode 277
  SCANCODE_KBDILLUMTOGGLE*      = Scancode 278
  SCANCODE_KBDILLUMDOWN*        = Scancode 279
  SCANCODE_KBDILLUMUP*          = Scancode 280
  SCANCODE_EJECT*               = Scancode 281
  SCANCODE_SLEEP*               = Scancode 282

  SCANCODE_APP1*                = Scancode 283
  SCANCODE_APP2*                = Scancode 284

  # Values mapped from usage page 0x0C (USB consumer page).
  SCANCODE_AUDIOREWIND*         = Scancode 285
  SCANCODE_AUDIOFASTFORWARD*    = Scancode 286
